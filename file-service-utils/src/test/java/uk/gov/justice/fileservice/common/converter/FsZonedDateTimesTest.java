...
/**
 * Unit tests for the {@link FsZonedDateTimes} utility class.
 */
public class FsZonedDateTimesTest {

    @Test
    public void shouldConvertZoneDateTimeToSqlTimestamp() {
        final ZonedDateTime zonedDateTime = of(LocalDateTime.now(), UTC);
        final Timestamp dateTime = FsZonedDateTimes.toSqlTimestamp(zonedDateTime);
    ...
    public void shouldConvertSqlTimestampToZoneDateTime() {
        ...
        final ZonedDateTime dateTime = FsZonedDateTimes.fromSqlTimestamp(timestamp);
    ...
    public void shouldConvertNonUtcToUtcString() {
        final String dateTime = FsZonedDateTimes.toString(parse("2016-01-21T23:42:03.522+07:00"));
        assertThat(dateTime, equalTo("2016-01-21T16:42:03.522Z"));
    }

    @Test
    public void shouldConvertNonUtcToUtcString2() {
        final String dateTime = FsZonedDateTimes.toString(parse("2016-07-25T23:09:01.0+05:00"));
