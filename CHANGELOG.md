...
## [25.104.0-M8] - 2026-08-05
### Changed
- Bumped parent `maven-framework-parent-pom` to `25.104.0-M9` and `maven-common-bom.version` to `25.104.0-M7` — picks up the Apache Artemis client bump `2.53.0` → `2.54.0`.

## [25.104.0-M7] - 2026-07-27
### Changed
